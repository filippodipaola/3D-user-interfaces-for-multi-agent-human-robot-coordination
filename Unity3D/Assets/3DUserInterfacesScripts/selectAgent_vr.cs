...
public class selectAgent_vr : MonoBehaviour {
    ...
    public static HashSet<selectAgent_vr> allMySelectables = new HashSet<selectAgent_vr>();
    public static HashSet<selectAgent_vr> currentlySelected = new HashSet<selectAgent_vr>();
    ...
    {
        foreach (selectAgent_vr selectable in currentlySelected)
        {
